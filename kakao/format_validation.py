...
# This notebook serves as a tool to preprocess and analyze the chat dataset used for fine-tuning a chat model. It checks for format errors, provides basic statistics, 
# and estimates token counts for fine-tuning costs. 
# The method shown here corresponds to the current fine-tuning method for gpt-3.5-turbo. See legacy fine-tuning for models like babbage-002 and davinci-002.
import json
...
'''
data_path = "./KakaoTalkChats_conversations.json"
